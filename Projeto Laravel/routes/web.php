...
|
*/
Route::post('/processingForm', function(){
...
Route::prefix('aluno')->group(function(){
    ...
    Route::post('/visualizarNotas/turmaEscolhida', 'AlunoController@mostrarNotas'); //rota para visualizar as notas da turma que o aluno escolheu.
});
