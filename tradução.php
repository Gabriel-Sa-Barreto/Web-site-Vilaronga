...
<head>
    ...
    <title>Serviço de Tradução</title>
    <link rel="stylesheet" href="assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat:400,400i,700,700i,600,600i">
    <link rel="stylesheet" href="assets/fonts/fontawesome-all.min.css">
    <link rel="stylesheet" href="assets/fonts/font-awesome.min.css">
    <link rel="stylesheet" href="assets/fonts/simple-line-icons.min.css">
    <link rel="stylesheet" href="assets/css/css_traducao/Customizable-Background--Overlay.css">
    <link rel="stylesheet" href="assets/css/css_traducao/Features-Clean.css">
...
<body>
    ...
    <main class="page landing-page">
        <div style="background-image: url(&quot;imagens/traducao/technology.jpg&quot;);height: 550px;background-position: center;background-size: cover;background-repeat: no-repeat;">
    ...
    <div class="container" id="team" style = "margin-top: -30px;">
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-12 offset-sm-0 col-xs-12 offset-xs-0">
                 <div class="team-member"><img src="imagens/traducao/Ricardo.jpeg" class="rounded-circle img-fluid" style = "box-shadow: 5px 10px 8px 10px #888888;"/>
                            <br><br>
